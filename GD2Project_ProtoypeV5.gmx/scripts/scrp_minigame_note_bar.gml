...
instance_create(obj_placeholder.x + 880, obj_placeholder.y - 103, obj_note_down);
instance_create(obj_placeholder.x + 912, obj_placeholder.y - 39, obj_note_left);
instance_create(obj_placeholder.x + 976, obj_placeholder.y - 71, obj_note_right);
instance_create(obj_placeholder.x + 1040, obj_placeholder.y - 39, obj_note_left);
instance_create(obj_placeholder.x + 1104, obj_placeholder.y - 71, obj_note_right);
global.note_count++;
}
